...
function Business({navigation}) {
    ...
    useEffect(()=>{
        //api link
        fetch('https://newsapi.org/v2/top-headlines?country=ng&category=business&apiKey=922c23065f764af8af4b68a48a08d796',{
            method:'GET'
    ...
    return (
        <SafeAreaView style={styles.body}>
            ...
            <Text style={{fontSize:20, fontWeight:'bold',alignSelf:'center', textDecorationLine:'underline', color:'#007aff'}}>Business Headline NG</Text>
